...
public class Enemy : MonoBehaviour {
    ...
    public Transform[] evadeDestinationTransform = new Transform[2];
    ...
    public void CheckNewWay() {
        if (!evading) {
            evadeDestinationTransform[0].localPosition = new Vector3(-1, -1, 0) * Vector3.Distance(transform.position, playerTransform.position) / 2;
            evadeDestinationTransform[1].localPosition = new Vector3(1, -1, 0) * Vector3.Distance(transform.position, playerTransform.position) /2;
